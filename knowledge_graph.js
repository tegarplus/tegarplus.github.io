async function getKnowledgeGraphs() {
  const diagrams = [{ title: "Using graph", filename: "knowledge_graph" }];
...
async function drawKnowledgeGraph(container) {
  const diagrams = await getKnowledgeGraphs();
